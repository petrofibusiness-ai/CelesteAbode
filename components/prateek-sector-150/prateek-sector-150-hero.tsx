...
export function PrateekSector150Hero() {
  return (
    <section
      className="relative min-h-svh w-full overflow-hidden bg-[#1a1612]"
      aria-labelledby="prateek-sector-150-h1"
      data-site-hero
      data-hero-no-section-pad
    >
      <div className="absolute inset-0">
        <Image
          src={PRATEEK_SECTOR_150_HERO_IMAGE}
          alt="Prateek Group Art Deco ultra-luxury high-rise residences in Sector 150, Noida"
          fill
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#1a1612]/70 via-[#1a1612]/25 to-[#1a1612]/30" />
      </div>
          ...
          <div className="pointer-events-auto max-w-5xl text-left">
            ...
            <div className="mt-3 flex items-start gap-2">
              ...
              <p
                ...
                style={{ fontFamily: "Poppins, sans-serif" }}
              >
                Sector 150, Noida Expressway · 3 &amp; 4 BHK Ultra luxury · Pre-launch
              </p>
            </div>
          </div>

...
export function PrateekSector150FooterCta() {
  ...
  return (
    <>
      <BrochureDownloadDialog
        ...
        propertyName={PRATEEK_SECTOR_150_PROJECT_NAME}
        propertySlug={PRATEEK_SECTOR_150_SLUG}
      />
      <section
        id="prateek-footer-cta"
        className="relative overflow-hidden bg-gradient-to-br from-[#1a1612] via-[#2a2218] to-[#1a1612] py-16 md:py-20"
        aria-label={`Enquire about ${PRATEEK_SECTOR_150_PROJECT_NAME}`}
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-12">
          <div className="mx-auto max-w-2xl text-center sm:max-w-3xl">
            ...
            >
              Ready to explore <span className="text-[#CBB27A]">{PRATEEK_SECTOR_150_PROJECT_NAME}</span>?
            </h2>
            <p
              className="mt-4 text-sm leading-relaxed text-white/80 sm:text-base md:text-lg"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >
              Download the pre-launch brief or book a consultation. We help you understand allotment, payment
              structure, and unit options before you commit.
            </p>

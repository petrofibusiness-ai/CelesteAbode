...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${SITE_URL}/pre-launch-properties`,
      lastModified: new Date(),
      changeFrequency: 'daily',
      priority: 0.85,
    },
    ...
    {
      url: `${SITE_URL}/residential-property-in-noida`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/commercial-property-in-noida`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/flats-for-sale-in-noida`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    ...
    {
      url: `${SITE_URL}/flats-in-ghaziabad`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.8,
    },

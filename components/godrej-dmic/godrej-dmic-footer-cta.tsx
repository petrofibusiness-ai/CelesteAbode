...
export function GodrejDmicFooterCta() {
  ...
  return (
    <>
      <BrochureDownloadDialog
        ...
        propertyName={GODREJ_DMIC_PROJECT_NAME}
        propertySlug={GODREJ_DMIC_SLUG}
      />
      <section
        id="godrej-dmic-footer-cta"
        className="relative overflow-hidden bg-gradient-to-br from-[#141816] via-[#24302a] to-[#141816] py-16 md:py-20"
        aria-label={`Enquire about ${GODREJ_DMIC_PROJECT_NAME}`}
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-12">
          <div className="mx-auto max-w-2xl text-center sm:max-w-3xl">
            ...
            >
              Want the brief on <span className="text-[#CBB27A]">{GODREJ_DMIC_PROJECT_NAME}</span>?
            </h2>
            <p

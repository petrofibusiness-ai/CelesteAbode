...
export function SgNakshatraFooterCta() {
  ...
  return (
    <>
      <BrochureDownloadDialog
        ...
        propertyName={SG_NAKSHATRA_PROJECT_NAME}
        propertySlug={SG_NAKSHATRA_SLUG}
      />
      <section
        id="sg-nakshatra-footer-cta"
        className="relative overflow-hidden bg-gradient-to-br from-[#141816] via-[#24302a] to-[#141816] py-16 md:py-20"
        aria-label={`Enquire about ${SG_NAKSHATRA_PROJECT_NAME}`}
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-12">
          <div className="mx-auto max-w-2xl text-center sm:max-w-3xl">
            ...
            >
              Want the brief on <span className="text-[#CBB27A]">{SG_NAKSHATRA_PROJECT_NAME}</span>?
            </h2>
            <p
              className="mt-4 text-sm leading-relaxed text-white/80 sm:text-base md:text-lg"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >
              EOI is open in Siddharth Vihar. We will send the current sheet and share UP RERA{" "}

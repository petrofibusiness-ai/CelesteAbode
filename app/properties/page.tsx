...
import { Loader2, MapPin, Building2, Star } from "lucide-react";
...
function sortPropertiesByFeaturedThenDateDesc(a: Property, b: Property): number {
    ...
    async (filterState: FilterState, page: number, mode: FetchMode = "filter") => {
      ...
      try {
        if (filterState.location.length === 0) {
          ...
          const mergedSorted = Array.from(uniquePropertiesMap.values()).sort(sortPropertiesByFeaturedThenDateDesc);

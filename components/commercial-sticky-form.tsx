...
export function CommercialStickyForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3.5">
      <div>
        <label htmlFor="com-name" className={labelClass}>Name</label>
        <input
          id="com-name"
          type="text"
          value={name}
      ...
      <div>
        <label htmlFor="com-phone" className={labelClass}>Phone Number</label>
        <input
          id="com-phone"
          type="tel"
          value={phone}
      ...
      <div>
        <label htmlFor="com-pt" className={labelClass}>Property Type</label>
        <select
          id="com-pt"
          value={propertyType}
      ...
      <div>
        <label htmlFor="com-budget" className={labelClass}>Your Budget</label>
        <select
          id="com-budget"
          value={budget}
      ...
      <div>
        <label htmlFor="com-timeline" className={labelClass}>Timeline</label>
        <select
          id="com-timeline"
          value={timeline}

  ...
  const audiences = [
    {
      ...
      fullText: "Our real estate consultants in Noida guide first-time buyers through each step of the process: what to verify before a site visit, how to read a builder-buyer agreement, and what possession timelines look like in practice versus on paper.",
    ...
    },
    {
      ...
      fullText: "Greater Noida West averaged 24% growth. A property consultant in Noida with investment experience builds your shortlist around verified appreciation data and yield benchmarks, not projected returns used to close a deal.",
    ...
    },
    {
      ...
      fullText: "Finding a real estate consultant in Delhi NCR is harder when you are not on the ground. We handle the full process remotely: legal verification, site visit coordination, agreement review, and loan liaison, so you commit to something fully checked, not just well-photographed.",
    ...
    },
    {
      ...
      fullText: "Office space selection, pre-leased asset evaluation, yield assessment, and lease structure review all demand sector-specific knowledge. A property consultant in Noida with commercial expertise helps organisations avoid spaces with occupancy gaps or unfavourable lease escalation clauses.",
    ...
    },
    {
      ...
      fullText: "As a property consultant in Noida with deep local market knowledge, we provide market intelligence and advisory support that helps developers align their offerings with what serious buyers are actually looking for.",

...
import { HotPropertyBanner } from "@/components/hot-property-banner";
...
export function Header({ alwaysBlack = false, hideSocialIcons = false }: HeaderProps) {
  ...
  const showPromoBanner = !isAdminRoute;
                  ...
                  <AnimatePresence>
                    {isPropertiesOpen && (
                      <motion.div
                        ...
                        className="absolute top-full left-1/2 z-[60] w-72 -translate-x-1/2"
                        style={{ 
                          marginTop: '0px'
                        }}
                      >

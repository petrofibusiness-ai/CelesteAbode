...
export function KaryanResidencesNh24MapEmbed({ className = "" }: { className?: string }) {
  return (
    <div
...
export function KaryanResidencesNh24StickySidebar({
  idPrefix = "karyan",
  part = "all",
}: {
  idPrefix?: string;
        ...
        {showCallback ? (
          ...
          >
            ...
            <p className="mt-1.5 text-xs leading-relaxed text-gray-400">
              Share your name and number. We&apos;ll walk you through EOI, unit preference, and how this NH-24 launch

...
export async function POST(request: NextRequest) {
  try {
    ...
    const location: Omit<Location, "id" | "createdAt" | "updatedAt"> = {
      ...
      compareLocation1: typeof body.compareLocation1 === 'string' ? body.compareLocation1 : null,
      compareLocation2: typeof body.compareLocation2 === 'string' ? body.compareLocation2 : null,
      compareLocation3: typeof body.compareLocation3 === 'string' ? body.compareLocation3 : null,

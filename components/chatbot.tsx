...
export function Chatbot() {
  ...
  return (
    <>
      {/* Left: Instagram, LinkedIn, WhatsApp - sticky, vertically centered (hidden on mobile) */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="hidden md:flex fixed left-4 sm:left-6 top-1/2 -translate-y-1/2 z-[9999] flex-col gap-3 sm:gap-4"
      >
        <a
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full p-3 sm:p-4 shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 touch-manipulation"
          aria-label="WhatsApp"
        >
      ...
      {/* Right: Call Button - Above Chatbot */}
      <motion.a

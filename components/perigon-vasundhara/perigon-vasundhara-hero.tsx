...
export function PerigonVasundharaHero() {
  return (
    <section
      className="relative min-h-svh w-full overflow-hidden bg-[#161412]"
      aria-labelledby="perigon-vasundhara-h1"
      data-site-hero
      data-hero-no-section-pad
    >
      <div className="absolute inset-0">
        <Image
          src={PERIGON_VASUNDHARA_HERO_IMAGE}
          alt="Ultra-luxury 3 & 4 BHK high-rise residences at Vasundhara, Ghaziabad, with Sky Infinity Pool and Grand Clubhouse"
          fill
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#161412]/75 via-[#161412]/25 to-[#161412]/35" />
      </div>
          ...
          <div className="pointer-events-auto max-w-5xl text-left">
            ...
            <div className="mt-3 flex items-start gap-2">
              ...
              <p
                ...
                style={{ fontFamily: "Poppins, sans-serif" }}
              >
                Sector 4, Vasundhara · 3 &amp; 4 BHK Ultra-luxury · Pre Launch
              </p>
            </div>
          </div>

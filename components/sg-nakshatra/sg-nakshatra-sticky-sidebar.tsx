...
import { SG_NAKSHATRA_PROJECT_NAME, SG_NAKSHATRA_RERA_ID, SG_NAKSHATRA_SLUG } from "@/lib/sg-nakshatra-assets";
...
const PROPERTY_NAME = SG_NAKSHATRA_PROJECT_NAME;
const PROPERTY_SLUG = SG_NAKSHATRA_SLUG;

const MAPS_EMBED_SRC =
  "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21601.983433114627!2d77.39354719672222!3d28.658256912132344!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cf03ef22ad733%3A0xdfa1d3511f33ee5!2sSiddharth%20Vihar%2C%20Indirapuram%2C%20Ghaziabad%2C%20Uttar%20Pradesh%20201009!5e0!3m2!1sen!2sin!4v1789424546638!5m2!1sen!2sin";

export function SgNakshatraMapEmbed({ className = "" }: { className?: string }) {
  return (
    <div
    ...
    >
      <iframe
        src={MAPS_EMBED_SRC}
        title={`${SG_NAKSHATRA_PROJECT_NAME} on Google Maps`}
...
export function SgNakshatraStickySidebar({
  idPrefix = "sg-nakshatra",
  part = "all",
}: {
  idPrefix?: string;
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const message = `WhatsApp enquiry for ${SG_NAKSHATRA_PROJECT_NAME} (pre-launch). Submitted from the property page.`;
    ...
    try {
      const res = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          message,
          formSource: `property-page-${SG_NAKSHATRA_SLUG}`,
          propertyTitle: PROPERTY_NAME,
          propertyLocation: "Siddharth Vihar, NH-24, Ghaziabad",
            ...
            <div className="flex gap-2.5">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 text-[11px] leading-snug text-gray-400">
                  EOI is open. Share your details and we will send the current pre-launch brief.
                </p>
              </div>
            </div>
        ...
        {showCallback ? (
          ...
          >
            ...
            <p className="mt-1.5 text-xs leading-relaxed text-gray-400">
              Share your name and number. We will walk you through EOI, sizes, and UP RERA {SG_NAKSHATRA_RERA_ID}.
            </p>

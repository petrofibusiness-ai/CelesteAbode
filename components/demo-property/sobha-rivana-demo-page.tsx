    ...
    <>
      ...
      <div className="min-h-screen bg-white text-gray-900 antialiased">
        ...
        <main className="pb-8 pt-0">
          ...
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 md:px-12 md:py-16 lg:px-10 xl:px-14 lg:pt-0">
            <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_288px] lg:items-start lg:gap-x-6 xl:gap-x-8">
              <div className="hidden min-w-0 lg:col-start-1 lg:row-start-1 lg:block">
                <SobhaRivanaHero />
              </div>
              ...
              <aside
                ...
                className="hidden min-w-0 lg:col-start-2 lg:row-start-2 lg:block lg:self-start"
              >
                <div className="sticky top-[var(--site-header-total,6rem)] z-10 xl:top-[calc(var(--site-header-total,6rem)+1rem)]">

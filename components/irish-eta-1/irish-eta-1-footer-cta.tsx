...
export function IrishEta1FooterCta() {
  ...
  return (
    <>
      <BrochureDownloadDialog
        ...
        propertyName={IRISH_ETA_1_PROJECT_NAME}
        propertySlug={IRISH_ETA_1_SLUG}
      />
      <section
        id="irish-eta-1-footer-cta"
        className="relative overflow-hidden bg-gradient-to-br from-[#14201c] via-[#1c2e28] to-[#14201c] py-16 md:py-20"
        aria-label={`Enquire about ${IRISH_ETA_1_PROJECT_NAME}`}
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-12">
          <div className="mx-auto max-w-2xl text-center sm:max-w-3xl">
            ...
            >
              Ready to explore <span className="text-[#CBB27A]">{IRISH_ETA_1_PROJECT_NAME}</span>?
            </h2>
            <p

...
export function NotFoundContent() {
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      <Header alwaysBlack />
      <div
        className="flex items-center justify-center px-4 sm:px-6 relative py-8 sm:py-12 md:py-16"
        style={{ minHeight: "calc(100vh - 100px)", paddingTop: "100px" }}
      >
        ...
        <div className="max-w-xl md:max-w-2xl w-full text-center space-y-4 sm:space-y-6 md:space-y-8 relative z-10 flex flex-col items-center justify-center">
          ...
          >
            ...
            <p
              className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-md mx-auto leading-relaxed"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >

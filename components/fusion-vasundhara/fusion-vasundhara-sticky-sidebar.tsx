...
const MAPS_EMBED_SRC =
  "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11545.94385891166!2d77.37050789584335!3d28.65657044735789!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfaa190346543%3A0x6e5864290d738d89!2sSector%207%2C%20Vasundhara%2C%20Ghaziabad%2C%20Uttar%20Pradesh%20201012!5e0!3m2!1sen!2sin!4v1778250504312!5m2!1sen!2sin";

export function FusionVasundharaMapEmbed({ className = "" }: { className?: string }) {
  return (
    <div
    ...
    >
      <iframe
        src={MAPS_EMBED_SRC}
        title="Fusion Vasundhara, Sector 7 Vasundhara Ghaziabad on Google Maps"
...
export function FusionVasundharaStickySidebar({ idPrefix = "fusion" }: { idPrefix?: string }) {
  const WHATSAPP_NUMBER = "919910906306";
  const PROPERTY_NAME = "Fusion Vasundhara";
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const message =
      "WhatsApp enquiry for Fusion Vasundhara (Sector 7, Vasundhara, Ghaziabad). Submitted from the property page.";
    ...
    try {
      const res = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          message,
          formSource: "property-page-fusion-vasundhara",
          propertyTitle: PROPERTY_NAME,
          propertyLocation: "Sector 7, Vasundhara, Ghaziabad",
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          <div className="flex gap-2.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-0.5 text-sm font-bold leading-tight text-white">Brochure and details</p>
              <p className="mt-1 text-[11px] leading-snug text-gray-400">
                Get the brochure with sizes, prices, and payment plan.
              </p>
            </div>
          </div>
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-wider text-[#CBB27A]/90">Fusion Vasundhara</p>
          <h3 className="mt-2 text-lg font-bold leading-snug text-white">Request a callback</h3>
          <p className="mt-2 text-sm leading-relaxed text-gray-400">
            Share your name and phone. We will message you on WhatsApp with sizes, price, and next steps.
          </p>
          ...
          {isDone ? (
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-4">
              ...
              <div>
                <label
                  htmlFor={`${idPrefix}-inquiry-phone`}
                  className="mb-1 block text-xs font-semibold text-gray-400"
                >
                  Phone
                </label>

...
const PROPERTY_NAME = GODREJ_DMIC_PROJECT_NAME;
const PROPERTY_SLUG = GODREJ_DMIC_SLUG;

const MAPS_EMBED_SRC =
  "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1970083.3272029413!2d78.07312055865889!3d28.605250944412255!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cbf055ced9ea1%3A0x8a434fbc31cedaa!2sGodrej%20Properties%20DMIC%2C%20Greater%20Noida!5e0!3m2!1sen!2sin!4v1789424513331!5m2!1sen!2sin";

export function GodrejDmicMapEmbed({ className = "" }: { className?: string }) {
  return (
    <div
    ...
    >
      <iframe
        src={MAPS_EMBED_SRC}
        title={`${GODREJ_DMIC_PROJECT_NAME} on Google Maps`}
...
export function GodrejDmicStickySidebar({
  idPrefix = "godrej-dmic",
  part = "all",
}: {
  idPrefix?: string;
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const message = `WhatsApp enquiry for ${GODREJ_DMIC_PROJECT_NAME} (pre-launch). Submitted from the property page.`;

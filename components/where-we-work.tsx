        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
          {locations.map((location, index) => (
            ...
            >
              ...
              >
                <div className="relative h-[280px] md:h-[360px] lg:h-[400px] rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-[1.02]">
                  {/* Location Image */}
                  <Image
                    src={location.image}
                    alt={location.alt}
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/30 group-hover:from-black/95 group-hover:via-black/60 transition-opacity duration-500" />

                  {/* Content Overlay - Centered Location Name */}
                  <div className="absolute inset-0 flex items-center justify-center p-6 md:p-8">
                    <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white uppercase tracking-wide leading-tight group-hover:text-[#CBB27A] transition-colors duration-300 text-center">
                      {location.title}
                    </h3>
                  </div>
                </div>

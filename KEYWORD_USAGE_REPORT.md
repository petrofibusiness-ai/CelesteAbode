# Keyword Usage Report - Celeste Abode Website

## Overview
This document provides a comprehensive breakdown of keyword usage across all pages of the Celeste Abode website.

---

## 1. Homepage (`/`)
**File:** `app/layout.tsx` (Global) + `app/page.tsx`

### Title
- "Luxury Real Estate NCR | Investment Advisory | Celeste Abode"
...
#### Location-based Keywords - Noida (15)
...
#### Location-based Keywords - Greater Noida (8)
...
#### Location-based Keywords - Gurugram/Gurgaon (8)
...
#### Location-based Keywords - Delhi NCR (8)
...
#### Location-based Keywords - Other Areas (7)
...
#### Connectivity & Infrastructure Keywords (9)
...
#### Market Intelligence Keywords (5)
...
#### Arihant Abode Project Keywords (42)
- Arihant Abode
...
#### Real Estate Consulting & Advisory Keywords (33)
...
#### Additional Competitor Keywords (10)
...
### Keywords Used (in content, no explicit metadata)
- Trust, Transparency, Transformation
- RERA-aligned diligence
- ROI, absorption, and risk reports
- AI curation
- human insight
- data-backed decision-making
- strategic partners
- Top 3 Definitive Projects
- absorption rates
- yield bands
- exit liquidity forecasts

**Note:** This page does not have explicit metadata keywords defined. It relies on content-based SEO.
...
- High-Value Investment Advisory
- NRI & Global Client Services
- End-to-End Consulting
- Personalised Lifestyle Mapping
...
- Property Types
- Strategic Q&A
- Buying an Apartment or Home
- Real Estate Investment & Trading
...
**Note:** This page does not have explicit metadata keywords defined. It relies on content-based SEO with FAQ schema.

---

## 6. Projects Listing Page (`/projects`)
...
### 7.1 Arihant Abode (`/projects/arihant-abode`)
**File:** `lib/project-metadata.ts` (ID: 1)
...
### 7.2 Spring Elmas (`/projects/spring-elmas`)
**File:** `lib/project-metadata.ts` (ID: 2)
...
### 7.3 Eternia Residences (`/projects/eternia-residences`)
**File:** `lib/project-metadata.ts` (ID: 3)
...
### 7.4 RG Pleiaddes (`/projects/rg-pleiaddes`)
**File:** `lib/project-metadata.ts` (ID: 4)
...
### 7.5 Irish Platinum (`/projects/irish-platinum`)
**File:** `lib/project-metadata.ts` (ID: 5)
...
### 7.6 Elite X (`/projects/elite-x`)
**File:** `lib/project-metadata.ts` (ID: 6)
...
### 7.7 ACE Hanei (`/projects/ace-hanei`)
**File:** `lib/project-metadata.ts` (ID: 7)
...
### 7.8 The Brook & Rivulet (`/projects/the-brook-and-rivulet`)
**File:** `lib/project-metadata.ts` (ID: 8)
...
### 7.9 Renox Thrive (`/projects/renox-thrive`)
**File:** `lib/project-metadata.ts` (ID: 9)
...
### 7.10 Civitech Strings (`/projects/civitech-strings`)
**File:** `lib/project-metadata.ts` (ID: 10)
...
### 7.11 Forest Walk Villa (`/projects/forest-walk-villa`)
**File:** `lib/project-metadata.ts` (ID: 11)
...
### 7.12 VVIP (`/projects/vvip`)
**File:** `lib/project-metadata.ts` (ID: 12)
...
### 7.13 Panchsheel Greens-II (`/projects/panchsheel-greens-ii`)
**File:** `lib/project-metadata.ts` (ID: 13)
...
## 8. Advisory Session Page (`/advisory-session`)
...
**Note:** This page typically does not require SEO keywords as it's a legal/informational page.
...
### Total Keywords by Page Type:
1. **Homepage:** 292 keywords (most comprehensive)
2. **Services Page:** 10 keywords
3. **Individual Project Pages:** 18-38 keywords each (13 projects)
4. **Other Pages:** Content-based SEO (no explicit keyword metadata)

### Keyword Categories Coverage:
- ✅ Primary/Service Keywords
- ✅ Location-based Keywords (Noida, Greater Noida, Gurugram, Delhi NCR, Ghaziabad, Yamuna Expressway)
- ✅ Property Type Keywords (Apartments, Villas, Plots, Commercial)
- ✅ BHK-specific Keywords (2 BHK, 3 BHK, 4 BHK)
- ✅ Property Status Keywords (Ready to Move, Under Construction, Pre-Launch)
...
- ✅ Project-specific Keywords (13 projects)
- ✅ NRI & Specialized Services Keywords

### Recommendations:
1. Add explicit metadata keywords to Philosophy, Contact, Vault, Projects listing, and Advisory Session pages
2. Consider adding more long-tail keywords for better niche targeting
3. Monitor keyword performance and update based on search trends
4. Ensure keyword density is natural and not over-optimized

---

**Report Generated:** $(date)
**Total Pages Analyzed:** 22 pages
